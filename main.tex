...
\advisor[major]{김용대}{Yong-Dae Kim}{signed}
\advisor[major2]{김용대}{Yong-Dae Kim}{signed} %한글 성과 한글 이름을 모두 붙여 써 주시기 바랍니다.
\advisor[coopr]{손수엘}{Soo-el Son}{}
\advisor[coopr2]{손수엘}{Soo-el Son}{} 
\advisorinfo{Graduate school of information security} %제출승인서에 들어가는 교수님 정보, advisor's information  
...
\department{CS}{engineering}{Information Security}
...
%% You cannot use 'part'
		...
		\input{sections/chapter1/background}
		\input{sections/chapter1/attackModel}
		\input{sections/chapter1/attack}
		\input{sections/chapter1/defense}
		\input{sections/chapter1/scalarable}
		\input{sections/chapter1/RelatedWork}
